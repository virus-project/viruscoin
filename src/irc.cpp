...
void ThreadIRCSeed(void* parg)
{
    ...
    RenameThread("VirusCoin-ircseed");
...
void ThreadIRCSeed2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #VirusCoinTEST\r");
            ...
            Send(hSocket, strprintf("JOIN #VirusCoin2017_%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #VirusCoin2017_%02d\r", channel_number).c_str());
        }
