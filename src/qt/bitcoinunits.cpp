...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("VRS");
    case mBTC: return QString("mVRS");
    case uBTC: return QString::fromUtf8("μVRS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("VirusCoins"));
    case mBTC: return QString(QObject::tr("Milli-VirusCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-VirusCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
